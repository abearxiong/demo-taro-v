  ...
  return (function (e) {
    ...
    function (e, t, i) {
      ...
      (n.isReserved = function (e) {
            ...
            (i = e.charCodeAt(n)),
              i >= 65536 && i <= 1114111
                ...
                ? (r.push(((i >> 12) & 15) | 224),
                  ...
                  r.push((63 & i) | 128))
                : i >= 128 && i <= 2047
                ? (r.push(((i >> 6) & 31) | 192), r.push((63 & i) | 128))
                : r.push(255 & i);
          return r;
        }),
        (n.byteToString = function (e) {
          if ("string" == typeof e) return e;
          for (var t = "", i = e, r = 0; r < i.length; r++) {
            var n = i[r].toString(2),
              o = n.match(/^1+?(?=0)/);
            if (o && 8 == n.length) {
              for (
                var s = o[0].length, a = i[r].toString(2).slice(7 - s), u = 1;
                u < s;
                u++
              )
                a += i[u + r].toString(2).slice(2);
              (t += String.fromCharCode(parseInt(a, 2))), (r += s - 1);
            } else t += String.fromCharCode(i[r]);
          }
          return t;
        }),
        (n.isInteger =
        ...
        Object.defineProperty(n, "decorateRoot", {
          get: function () {
            return o.decorated || (o.decorated = new (i(11))());
          },
        });
    },
    function (e, t, i) {
      function r(e, t, i, r, o) {
        if ((n.call(this, e, i), t && "object" != typeof t))
      ...
      e.exports = r;
      var n = i(4);
      ((r.prototype = Object.create(n.prototype)).constructor = r).className =
        "Enum";
      var o = i(7);
    ...
    function (e, t, i) {
      function r(e, t, i, r, o, u, f) {
        ...
        if (void 0 !== r && !h.test((r = r.toString().toLowerCase())))
        ...
        (this.rule = r && "optional" !== r ? r : void 0),
          ...
          (this.long = !!a.Long && void 0 !== s.long[i]),
          (this.bytes = "bytes" === i),
      ...
      (r.fromJSON = function (e, t) {
        return new r(e, t.id, t.type, t.rule, t.extend, t.options, t.comment);
      }),
        Object.defineProperty(r.prototype, "packed", {
          get: function () {
            return (
              null === this._packed &&
          ...
          return (
            ...
            function (o, s) {
              a.decorateType(o.constructor).add(
                new r(s, e, t, i, { default: n })
              );
            }
          );
        }),
        (r._configure = function () {
          (u = i(3)), (o = i(1)), (s = i(5)), (a = i(0));
        });
    },
    function (e, t, i) {
      function r(e, t) {
      ...
      e.exports = r;
      var o = i(7);
      ((r.prototype = Object.create(o.prototype)).constructor = r).className =
        "Type";
      var s, a, u, h, f, l, c, d, p, y, m, v, g, b;
      Object.defineProperties(r.prototype, {
        ...
        fieldsArray: {
          get: function () {
            return (
              this._fieldsArray || (this._fieldsArray = c.toArray(this.fields))
            );
          },
        },
        oneofsArray: {
          get: function () {
            return (
              this._oneofsArray || (this._oneofsArray = c.toArray(this.oneofs))
            );
          },
        },
        ctor: {
          get: function () {
            return this._ctor || (this.ctor = r.generateConstructor(this));
          },
          set: function (e) {
            var t = e.prototype;
            t instanceof u ||
              ...
              c.merge(e, u, !0),
              c.merge(e.prototype, u, !0),
              (this._ctor = e);
            for (var i = 0; i < this.fieldsArray.length; ++i)
              this._fieldsArray[i].resolve();
            var r = {};
            for (i = 0; i < this.oneofsArray.length; ++i) {
              var n = this._oneofsArray[i].resolve().name,
                o = (function (e) {
              ...
              r[n] = { get: o.getter, set: o.setter };
            }
            i && Object.defineProperties(e.prototype, r);
          },
        },
      }),
        (r.generateConstructor = function (e) {
          return function (t) {
            for (var i, r = 0; r < e.fieldsArray.length; r++)
              (i = e._fieldsArray[r]).map
                ? (this[i.name] = {})
                : i.repeated && (this[i.name] = []);
            if (t)
              for (var n = Object.keys(t), o = 0; o < n.length; ++o)
                null != t[n[o]] && (this[n[o]] = t[n[o]]);
          };
        }),
        (r.fromJSON = function (e, t) {
          var i = new r(e, t.options);
          (i.extensions = t.extensions), (i.reserved = t.reserved);
          for (var n = Object.keys(t.fields), u = 0; u < n.length; ++u)
            i.add(
              (void 0 !== t.fields[n[u]].keyType ? b.fromJSON : a.fromJSON)(
                n[u],
                t.fields[n[u]]
              )
            );
          if (t.oneofs)
            for (n = Object.keys(t.oneofs), u = 0; u < n.length; ++u)
              i.add(h.fromJSON(n[u], t.oneofs[n[u]]));
          if (t.nested)
            for (n = Object.keys(t.nested), u = 0; u < n.length; ++u) {
              var f = t.nested[n[u]];
              i.add(
                (void 0 !== f.id
                  ? a.fromJSON
        ...
        (r.prototype.toJSON = function (e) {
          ...
          return {
            ...
            oneofs: o.arrayToJSON(this.oneofsArray, e),
            fields:
              o.arrayToJSON(
            ...
            comment: i ? this.comment : void 0,
          };
        }),
        (r.prototype.resolveAll = function () {
        ...
        (r.prototype.setup = function () {
          ...
          (this.encode = p(this)({ Writer: f, types: t, util: c })),
            (this.decode = y(this)({ Reader: l, types: t, util: c })),
          ...
          if (r) {
            ...
            (n.fromObject = this.fromObject),
              (this.fromObject = r.fromObject.bind(n)),
              (n.toObject = this.toObject),
              (this.toObject = r.toObject.bind(n));
          }
          return this;
        }),
        ...
        (r.prototype.encodeDelimited = function (e, t) {
          return this.encode(e, t && t.len ? t.fork() : t).ldelim();
        }),
        (r.prototype.decode = function (e, t) {
          return this.setup().decode(e, t);
        }),
        (r.prototype.decodeDelimited = function (e) {
          return (
            e instanceof l || (e = l.create(e)), this.decode(e, e.uint32())
          );
        }),
        ...
        (r.prototype.toObject = function (e, t) {
    ...
    function (e, t, i) {
      ...
      (e.exports = r), (r.className = "ReflectionObject");
      var n, o;
      Object.defineProperties(r.prototype, {
        root: {
          get: function () {
        ...
        (r.prototype.resolve = function () {
          return this.resolved
            ? this
            : (this.root instanceof o && (this.resolved = !0), this);
        }),
        ...
        (r.prototype.setOption = function (e, t, i) {
          return (
            (i && this.options && void 0 !== this.options[e]) ||
    ...
    function (e, t, i) {
      ...
      function r(e, t) {
        var i = 0,
          r = {};
        for (t |= 0; i < e.length; ) r[s[i + t]] = e[i++];
        return r;
      }
      var n = e.exports,
        o = i(0),
    ...
    function (e, t, i) {
      ...
      t.BezierPath = function e(t, i, n) {
        r(this, e), (this._d = t), (this._transform = i), (this._styles = n);
      };
    },
    function (e, t, i) {
      function r(e, t) {
      ...
      (n.fromJSON = function (e, t) {
        ...
        (n.prototype.toJSON = function (e) {
          return h.toObject([
            ...
            this.options,
            "nested",
            r(this.nestedArray, e),
          ]);
        }),
        (n.prototype.addJSON = function (e) {
          var t = this;
          if (e)
            for (var i, r = Object.keys(e), o = 0; o < r.length; ++o)
              (i = e[r[o]]),
                t.add(
                  (void 0 !== i.fields
                    ? f.fromJSON
        ...
        (n.prototype.define = function (e, t) {
          ...
          for (var i = this; e.length > 0; ) {
            ...
            if (i.nested && i.nested[r]) {
              if (!((i = i.nested[r]) instanceof n))
                throw Error("path conflicts with non-namespace objects");
            } else i.add((i = new n(r)));
          }
        ...
        (n.prototype.lookup = function (e, t, i) {
          ...
          if (r) {
            ...
            } else if (r instanceof n && (r = r.lookup(e.slice(1), t, !0)))
              return r;
          } else
        ...
        (n._configure = function () {
          (a = i(1)), (u = i(2)), (h = i(0)), (f = i(3)), (l = i(12));
        });
    },
    function (e, t, i) {
      function r(e, t, i, r) {
      ...
      (r.fromJSON = function (e, t) {
        ...
        (r.d = function () {
          for (
            ...
            e[t] = arguments[t++];
          return function (t, i) {
            a.decorateType(t.constructor).add(new r(i, e)),
      ...
      var o = {
          arraySet: function (e, t, i, r, n) {
            if (t.subarray && e.subarray)
              return void e.set(t.subarray(i, i + r), n);
            for (var o = 0; o < r; o++) e[n + o] = t[i + o];
          },
          flattenChunks: function (e) {
            var t, i, r, n, o, s;
            for (r = 0, t = 0, i = e.length; t < i; t++) r += e[t].length;
            for (s = new Uint8Array(r), n = 0, t = 0, i = e.length; t < i; t++)
    ...
    function (e, t, i) {
      ...
      (r.length = function (e) {
        ...
        (r.write = function (e, t, i) {
          for (var r, n, o = i, s = 0; s < e.length; ++s)
            (r = e.charCodeAt(s)),
              r < 128
                ? (t[i++] = r)
                : r < 2048
    ...
    function (e, t, i) {
      ...
      function o(e, t, i) {
          ...
          try {
            if (
              ...
              var n,
                ...
                u = 0;
              if (o.imports)
                for (; u < o.imports.length; ++u) (n = o.imports[u]), s(n);
              if (o.weakImports) {
                for (u = 0; u < o.weakImports.length; ++u) n = o.weakImports[u];
                s(n);
              }
            } else a.setOptions(i.options).addJSON(i.nested);
          } catch (e) {
            r(e);
          }
          r(null, a);
        ...
        function s(e) {
          a.names.indexOf(e) > -1 || (a.names.push(e), e in f && n(e, f[e]));
        }
        "function" == typeof t && ((i = t), (t = void 0));
        var a = this;
        if (!i) return p.asPromise(o, a, e, t);
        var u = null;
        if ("string" == typeof e) u = JSON.parse(e);
        else {
          if ("object" != typeof e) return void console.log("pb格式转化失败");
          u = e;
        }
        n(u.name, u.pbJsonStr);
      }
      function s(e, t) {
        var i = t.parent.lookup(t.extend);
        if (i) {
          var r = new l(t.fullName, t.id, t.type, t.rule, void 0, t.options);
          return (r.declaringField = t), (t.extensionField = r), i.add(r), !0;
        }
        return !1;
      }
      e.exports = r;
      ...
      (r.fromJSON = function (e, t) {
        ...
        (r.prototype.resolvePath = p.path.resolve),
        (r.prototype.parseFromPbString = o),
        (r.prototype.load = function e(t, i, r) {
          function o(e, t) {
            if (r) {
              var i = r;
              if (((r = null), l)) throw e;
              ...
              if (
                ...
                if (n.imports)
                  for (; s < n.imports.length; ++s)
                    (r = u.resolvePath(e, n.imports[s])) && a(r);
                if (n.weakImports)
                  for (s = 0; s < n.weakImports.length; ++s)
                    (r = u.resolvePath(e, n.weakImports[s])) && a(r, !0);
          ...
          function a(e, t) {
            ...
            if (!(u.files.indexOf(e) > -1)) {
              ...
              if (l) {
                var a;
                try {
                  a = p.fs.readFileSync(e).toString("utf8");
                } catch (e) {
                  return void (t || o(e));
                }
                s(e, a);
                ...
                ++c,
                  p.fetch(e, function (i, n) {
                    if ((--c, r))
                      return i
                        ? void (t ? c || o(null, u) : o(i))
                        : void s(e, n);
                  });
            }
          }
          ...
          var u = this;
          if (!r) return p.asPromise(e, u, t, i);
          var l = r === n,
            c = 0;
          p.isString(t) && (t = [t]);
          for (var d, y = 0; y < t.length; ++y)
            (d = u.resolvePath("", t[y])) && a(d);
          if (l) return u;
          c || o(null, u);
        }),
        (r.prototype.loadSync = function (e, t) {
      ...
      var y = /^[A-Z]/;
      (r.prototype._handleAdd = function (e) {
        if (e instanceof l)
          void 0 === e.extend ||
            e.extensionField ||
            s(this, e) ||
          ...
          y.test(e.name) && (e.parent[e.name] = e.values);
        else if (!(e instanceof d)) {
          if (e instanceof u)
            for (var t = 0; t < this.deferred.length; )
              s(this, this.deferred[t]) ? this.deferred.splice(t, 1) : ++t;
          for (var i = 0; i < e.nestedArray.length; ++i)
            this._handleAdd(e._nestedArray[i]);
          y.test(e.name) && (e.parent[e.name] = e);
        }
      }),
        (r.prototype._handleRemove = function (e) {
          if (e instanceof l) {
            if (void 0 !== e.extend)
              if (e.extensionField)
          ...
          } else if (e instanceof c) y.test(e.name) && delete e.parent[e.name];
          else if (e instanceof a) {
            for (var i = 0; i < e.nestedArray.length; ++i)
              this._handleRemove(e._nestedArray[i]);
            y.test(e.name) && delete e.parent[e.name];
          }
        }),
        (r._configure = function () {
          (u = i(3)),
    ...
    function (e, t, i) {
      ...
      (r.fromJSON = function (e, t) {
        ...
        Object.defineProperty(r.prototype, "methodsArray", {
          get: function () {
            return (
              this._methodsArray ||
        ...
        (r.prototype.create = function (e, t, i) {
          for (
            var r, n = new u.Service(e, t, i), o = 0;
            o < this.methodsArray.length;
            ++o
          ) {
            var s = a
              .lcFirst((r = this._methodsArray[o]).resolve().name)
              .replace(/[^$\w_]/g, "");
            n[s] = a.codegen(
              ["r", "c"],
      ...
      (i.fromNumber = function (e) {
        ...
        (i.from = function (e) {
          return "number" == typeof e
            ...
            ? i.fromNumber(parseInt(e, 10))
            : e.low || e.high
            ? new i(e.low >>> 0, e.high >>> 0)
            : r;
        }),
    ...
    function (e, t, i) {
      function r(e, t, i, r, o, a) {
        if ((n.call(this, e, t, r, void 0, void 0, o, a), !s.isString(i)))
      ...
      (r.fromJSON = function (e, t) {
        ...
        (r.d = function (e, t, i) {
          return (
            "function" == typeof i
              ? (i = s.decorateType(i).name)
              : i && "object" == typeof i && (i = s.decorateEnum(i).name),
            function (n, o) {
              s.decorateType(n.constructor).add(new r(o, e, t, i));
            }
          );
        }),
        (r._configure = function () {
    ...
    function (e, t, i) {
      ...
      t.EllipsePath = (function (e) {
        function t(e, i, o, s, a, u) {
          r(this, t);
          var h = n(this, (t.__proto__ || Object.getPrototypeOf(t)).call(this));
          return (
            (h._x = e),
            (h._y = i),
            (h._radiusX = o),
    ...
    function (e, t, i) {
      ...
      (s.create = y.Buffer
        ...
        y.Array !== Array &&
          (s.alloc = y.pool(s.alloc, y.Array.prototype.subarray)),
        (s.prototype._push = function (e, t, i) {
          return (
            (this.tail = this.tail.next = new r(e, t, i)), (this.len += t), this
          );
        }),
        ...
        (s.prototype.uint32 = function (e) {
          return (
            (this.len += (this.tail = this.tail.next = new h(
              (e >>>= 0) < 128
                ? 1
                : e < 16384
                ? 2
        ...
        (s.prototype.int32 = function (e) {
          return e < 0 ? this._push(f, 10, c.fromNumber(e)) : this.uint32(e);
        }),
        ...
        (s.prototype.fixed32 = function (e) {
          return this._push(l, 4, e >>> 0);
        }),
        (s.prototype.sfixed32 = s.prototype.fixed32),
        (s.prototype.fixed64 = function (e) {
          var t = c.from(e);
          return this._push(l, 4, t.lo)._push(l, 4, t.hi);
        }),
        (s.prototype.sfixed64 = s.prototype.fixed64),
        (s.prototype.float = function (e) {
          return this._push(y.float.writeFloatLE, 4, e);
        }),
        (s.prototype.double = function (e) {
          return this._push(y.float.writeDoubleLE, 8, e);
        });
      var v = y.Array.prototype.set
        ? function (e, t, i) {
            t.set(e, i);
          }
        : function (e, t, i) {
      ...
      (s.prototype.bytes = function (e) {
        ...
        (s.prototype.fork = function () {
          return (
            ...
            (this.head = this.tail = new r(n, 0, 0)),
            (this.len = 0),
            this
          );
        }),
        (s.prototype.reset = function () {
          return (
            this.states
              ...
              : ((this.head = this.tail = new r(n, 0, 0)), (this.len = 0)),
            this
          );
        }),
    ...
    function (e, t, i) {
      ...
      r.encode = function (e, t, i) {
        for (var r, o = null, s = [], a = 0, u = 0; t < i; ) {
          var h = e[t++];
          switch (u) {
            case 0:
              (s[a++] = n[h >> 2]), (r = (3 & h) << 4), (u = 1);
              break;
            case 1:
              (s[a++] = n[r | (h >> 4)]), (r = (15 & h) << 2), (u = 2);
              break;
            case 2:
              (s[a++] = n[r | (h >> 6)]), (s[a++] = n[63 & h]), (u = 0);
          }
          a > 8191 &&
      ...
      (r.decode = function (e, t, i) {
        for (var r, n = i, s = 0, a = 0; a < e.length; ) {
          ...
          switch (s) {
            case 0:
              ...
              break;
            case 1:
              (t[i++] = (r << 2) | ((48 & u) >> 4)), (r = u), (s = 2);
              break;
            case 2:
              (t[i++] = ((15 & r) << 4) | ((60 & u) >> 2)), (r = u), (s = 3);
              break;
            case 3:
              (t[i++] = ((3 & r) << 6) | u), (s = 0);
          }
    ...
    function (e, t, i) {
      ...
      function r(e, t, i) {
        ...
        function N(e, t) {
          var i = 1;
          switch (
            ("-" === e.charAt(0) && ((i = -1), (e = e.substring(1))), e)
          ) {
            case "inf":
            case "INF":
            case "Inf":
          ...
          if (y.test(e)) return i * parseInt(e, 10);
          if (v.test(e)) return i * parseInt(e, 16);
          if (b.test(e)) return i * parseInt(e, 8);
          if (_.test(e)) return i * parseFloat(e);
          throw O(e, "number", t);
        }
        function j(e, t) {
          switch (e) {
        ...
        function I(e, t, i) {
          var n = Y.line;
          if (
            (e && ((e.comment = re()), (e.filename = r.filename)), ie("{", !0))
          ) {
            for (var o; "}" !== (o = Q()); ) t(o);
            ie(";", !0);
          } else
            i && i(),
              ie(";"),
              e && "string" != typeof e.comment && (e.comment = re(n));
        }
        function C(e, t) {
          if (!k.test((t = Q()))) throw O(t, "type name");
          var i = new s(t);
          I(i, function (e) {
            if (!F(i, e))
              switch (e) {
                ...
                case "oneof":
                  ...
                  break;
                case "extensions":
                  T(i.extensions || (i.extensions = []));
                  break;
                case "reserved":
                  T(i.reserved || (i.reserved = []), !0);
                  break;
                default:
                  if (!oe || !x.test(e)) throw O(e);
                  ee(e), B(i, "optional");
              }
          }),
            e.add(i);
        ...
        function B(e, t, i) {
          var r = Q();
          if ("group" === r) return void R(e, t);
          if (!x.test(r)) throw O(r, "type");
          var n = Q();
          if (!k.test(n)) throw O(n, "name");
          (n = ae(n)), ie("=");
          var o = new a(n, j(Q()), r, t, i);
          I(
            o,
            function (e) {
              if ("option" !== e) throw O(e);
              z(o, e), ie(";");
            },
            function () {
              q(o);
            ...
            oe ||
              !o.repeated ||
              (void 0 === d.packed[r] && void 0 !== d.basic[r]) ||
              o.setOption("packed", !1, !0);
        }
        function R(e, t) {
          var i = Q();
          if (!k.test(i)) throw O(i, "name");
          var n = p.lcFirst(i);
          i === n && (i = p.ucFirst(i)), ie("=");
          var o = j(Q()),
            u = new s(i);
          u.group = !0;
          var h = new a(n, o, i, t);
        ...
        function P(e) {
          ie("<");
          var t = Q();
          if (void 0 === d.mapKey[t]) throw O(t, "type");
          ie(",");
          var i = Q();
          if (!x.test(i)) throw O(i, "type");
          ie(">");
          var r = Q();
          if (!k.test(r)) throw O(r, "name");
          ie("=");
          var n = new u(ae(r), j(Q()), t, i);
          I(
            n,
            function (e) {
              if ("option" !== e) throw O(e);
        ...
        function M(e, t) {
          if (!k.test((t = Q()))) throw O(t, "name");
          var i = new h(ae(t));
          I(i, function (e) {
            "option" === e ? (z(i, e), ie(";")) : (ee(e), B(i, "optional"));
          }),
            e.add(i);
        }
        function D(e, t) {
        ...
        function V(e, t) {
          if (ie("{", !0))
            do {
              if (!k.test((X = Q()))) throw O(X, "name");
              "{" === te()
                ? V(e, t + "." + X)
                : (ie(":"),
                  "{" === te() ? V(e, t + "." + X) : Z(e, t + "." + X, E(!0)));
            } while (!ie("}", !0));
          else Z(e, t, E(!0));
        }
        function Z(e, t, i) {
        ...
        function J(e, t) {
          if (!k.test((t = Q()))) throw O(t, "service name");
          var i = new l(t);
          I(i, function (e) {
            if (!F(i, e)) {
              if ("rpc" !== e) throw O(e);
        ...
        function U(e, t) {
          ...
          var r,
            ...
            s,
            a = t;
          if ((ie("("), ie("stream", !0) && (n = !0), !x.test((t = Q()))))
            throw O(t);
          if (
            ((r = t),
            ie(")"),
        ...
        function K(e, t) {
          if (!x.test((t = Q()))) throw O(t, "reference");
          var i = t;
          I(null, function (t) {
            switch (t) {
              case "required":
              ...
              case "optional":
                ...
                break;
              default:
                if (!oe || !x.test(t)) throw O(t);
                ee(t), B(e, "optional", i);
            }
          });
        }
        t instanceof o || ((i = t), (t = new o())), i || (i = r.defaults);
        for (
          var $,
            H,
            W,
            G,
            X,
            Y = n(e, i.alternateCommentMode || !1),
            Q = Y.next,
            ee = Y.push,
            te = Y.peek,
            ie = Y.skip,
          ...
          switch (X) {
            case "package":
              if (!ne) throw O(X);
              !(function () {
                if (void 0 !== $) throw O("package");
                if ((($ = Q()), !x.test($))) throw O($, "name");
                (se = se.define($)), ie(";");
              })();
              break;
            case "import":
        ...
        return (
          (r.filename = null),
          { package: $, imports: H, weakImports: W, syntax: G, root: t }
        );
      }
      (e.exports = r), (r.filename = null), (r.defaults = { keepCase: !1 });
      var n,
        o,
        s,
        a,
    ...
    function (e, t) {
      ...
      function r(e, t) {
        ...
        function l() {
          ...
          var n = t.exec(e);
          if (!n) throw r("string");
          return (_ = t.lastIndex), v(N), (N = null), i(n[1]);
        }
        function c(t) {
          return e.charAt(t);
        }
        function d(i, r) {
          (A = e.charAt(i++)), (S = x), (E = !1);
          var n;
          n = t ? 2 : 3;
          var o,
            s = i - n;
          ...
          for (var f = e.substring(i, r).split(h), l = 0; l < f.length; ++l)
            f[l] = f[l].replace(t ? u : a, "").trim();
          O = f.join("\n").trim();
        }
        function p(t) {
          var i = y(t);
          return /^\s*\/{1,2}/.test(e.substring(t, i));
        }
        function y(e) {
          for (var t = e; t < k && "\n" !== c(t); ) t++;
          return t;
        ...
        function m() {
          if (T.length > 0) return T.shift();
          if (N) return l();
          var i, o, s, a, u;
          do {
            if (_ === k) return null;
            for (i = !1; f.test((s = c(_))); )
              if (("\n" === s && ++x, ++_ === k)) return null;
            if ("/" === c(_)) {
              if (++_ === k) throw r("comment");
              if ("/" === c(_))
                if (t) {
                  if (((a = _), (u = !1), p(_))) {
                    u = !0;
          ...
          var h = _;
          if (((n.lastIndex = 0), !n.test(c(h++))))
            for (; h < k && !n.test(c(h)); ) ++h;
          var m = e.substring(_, (_ = h));
          return ('"' !== m && "'" !== m) || (N = m), m;
        }
        function v(e) {
          T.push(e);
        ...
        function b(e, t) {
          var i = g();
          if (i === e) return m(), !0;
          if (!t) throw r("token '" + i + "', '" + e + "' expected");
          return !1;
        }
        function w(e) {
          var i = null;
        ...
        return Object.defineProperty(
          { next: m, peek: g, push: v, skip: b, cmnt: w },
          "line",
          {
            get: function () {
              return x;
    ...
    function (e, t, i) {
      ...
      ((r.prototype = Object.create(n.EventEmitter.prototype)).constructor = r),
        (r.prototype.rpcCall = function e(t, i, r, o, s) {
          if (!o) throw TypeError("request must be specified");
          var a = this;
          if (!s) return n.asPromise(e, a, t, i, r, o);
          if (!a.rpcImpl)
          ...
          try {
            return a.rpcImpl(
              t,
              i[a.requestDelimited ? "encodeDelimited" : "encode"](o).finish(),
              function (e, i) {
                if (e) return a.emit("error", e, t), s(e);
                if (null === i) return void a.end(!0);
                if (!(i instanceof r))
                  try {
                    i = r[a.responseDelimited ? "decodeDelimited" : "decode"](
                      i
                    );
                  } catch (e) {
                    return a.emit("error", e, t), s(e);
                  }
                return a.emit("data", i, t), s(null, i);
              }
            );
          } catch (e) {
            return (
    ...
    function (e, t, i) {
      ...
      function n(e, t, i, n) {
        var o = n.types;
        if (e.resolvedType)
          if (e.resolvedType instanceof a) {
            var s = Object.keys(e.resolvedType.values);
            if (s.indexOf(i) < 0) return r(e, "enum value");
          } else {
            var h = o[t].verify(i);
            if (h) return e.name + "." + h;
          }
        else
          switch (e.type) {
            case "int32":
            ...
            case "fixed32":
            case "sfixed32":
              if (!u.isInteger(i)) return r(e, "integer");
              break;
            case "int64":
            case "uint64":
            case "sint64":
            ...
            case "sfixed64":
              if (
                !(
                  u.isInteger(i) ||
                  (i && u.isInteger(i.low) && u.isInteger(i.high))
                )
              )
                return r(e, "integer|Long");
              break;
            case "float":
            case "double":
              if ("number" != typeof i) return r(e, "number");
              break;
            case "bool":
              if ("boolean" != typeof i) return r(e, "boolean");
              break;
            case "string":
              if (!u.isString(i)) return r(e, "string");
              break;
            case "bytes":
              if (!((i && "number" == typeof i.length) || u.isString(i)))
                return r(e, "buffer");
          }
      }
      function o(e, t) {
        switch (e.keyType) {
          ...
          case "fixed32":
          case "sfixed32":
            if (!u.key32Re.test(t)) return r(e, "integer key");
            break;
          case "int64":
          case "uint64":
          case "sint64":
          case "fixed64":
          case "sfixed64":
            if (!u.key64Re.test(t)) return r(e, "integer|Long key");
            break;
          case "bool":
            if (!u.key2Re.test(t)) return r(e, "boolean key");
        }
      }
      function s(e) {
        return function (t) {
          return function (i) {
            var s;
            if ("object" != typeof i || null === i) return "object expected";
            var a,
              h = e.oneofsArray,
              f = {};
            h.length && (a = {});
            for (var l = 0; l < e.fieldsArray.length; ++l) {
              var c = e._fieldsArray[l].resolve(),
                d = i[c.name];
              if (!c.optional || (null != d && i.hasOwnProperty(c.name))) {
                var p;
                if (c.map) {
                  if (!u.isObject(d)) return r(c, "object");
                  var y = Object.keys(d);
                  for (p = 0; p < y.length; ++p) {
                    if ((s = o(c, y[p]))) return s;
                    if ((s = n(c, l, d[y[p]], t))) return s;
                  }
                } else if (c.repeated) {
                  if (!Array.isArray(d)) return r(c, "array");
                  for (p = 0; p < d.length; ++p)
                    if ((s = n(c, l, d[p], t))) return s;
                } else {
                  if (c.partOf) {
                    var m = c.partOf.name;
                    if (1 === f[c.partOf.name] && 1 === a[m])
                      return c.partOf.name + ": multiple values";
                    a[m] = 1;
                  }
                  if ((s = n(c, l, d, t))) return s;
                }
              }
            }
          };
      ...
      function r(e) {
        return function (t) {
          ...
          return function (t, a) {
            a = a || i.create();
            for (
              var u = e.fieldsArray.slice().sort(s.compareFieldsById), h = 0;
              h < u.length;
              h++
            ) {
              var f = u[h],
                l = e._fieldsArray.indexOf(f),
                c = f.resolvedType instanceof n ? "uint32" : f.type,
                d = o.basic[c],
                p = t[f.name];
              if (
                (f.resolvedType instanceof n &&
                  "string" == typeof p &&
                  (p = r[l].values[p]),
                f.map)
              ) {
                if (null != p && t.hasOwnProperty(f.name))
                  for (var y = Object.keys(p), m = 0; m < y.length; ++m)
                    a
                      .uint32(((f.id << 3) | 2) >>> 0)
                      .fork()
                      .uint32(8 | o.mapKey[f.keyType])
                      [f.keyType](y[m]),
                      void 0 === d
                        ? r[l]
                            .encode(p[y[m]], a.uint32(18).fork())
                            .ldelim()
                            .ldelim()
                        : a
                            .uint32(16 | d)
                ...
                if (p && p.length)
                  if (f.packed && void 0 !== o.packed[c]) {
                    a.uint32(((f.id << 3) | 2) >>> 0).fork();
                    for (var v = 0; v < p.length; v++) a[c](p[v]);
                    a.ldelim();
                  } else
                    for (var g = 0; g < p.length; g++)
                      void 0 === d
                        ? f.resolvedType.group
                          ? r[l]
                              .encode(p[g], a.uint32(((f.id << 3) | 3) >>> 0))
                              .uint32(((f.id << 3) | 4) >>> 0)
                          : r[l]
                              .encode(
                                p[g],
                              ...
                              .ldelim()
                        : a.uint32(((f.id << 3) | d) >>> 0)[c](p[g]);
              } else
                (!f.optional || (null != p && t.hasOwnProperty(f.name))) &&
                  (f.optional ||
                    (null != p && t.hasOwnProperty(f.name)) ||
                    console.warn(
                      "注意啦!!!很大概率会报错 类型:",
                  ...
                  void 0 === d
                    ? f.resolvedType.group
                      ? r[l]
                          .encode(p, a.uint32(((f.id << 3) | 3) >>> 0))
                          .uint32(((f.id << 3) | 4) >>> 0)
                      : r[l]
                          .encode(p, a.uint32(((f.id << 3) | 2) >>> 0).fork())
                          .ldelim()
                    : a.uint32(((f.id << 3) | d) >>> 0)[c](p));
            }
            return a;
          };
        };
      ...
      function n(e) {
        return function (t) {
          ...
          return function (t, h) {
            ...
            for (
              var f, l = void 0 === h ? t.len : t.pos + h, c = new this.ctor();
              t.pos < l;
                ...
                if (p == v.id) {
                  if (((m = !0), v.map))
                    t.skip().pos++,
                      ...
                      s.long[v.keyType],
                      void 0 == s.basic[b]
                        ? (c[g]["object" == typeof f ? u.longToHash(f) : f] = n[
                            y
                          ].decode(t, t.uint32()))
                        : (c[g]["object" == typeof f ? u.longToHash(f) : f] = t[
                            b
                          ]());
                  else if (v.repeated)
                    if (
                      ((c[g] && c[g].length) || (c[g] = []),
                      void 0 != s.packed[b] && 2 == (7 & d))
                    )
                      for (var w = t.uint32() + t.pos; t.pos < w; )
                        c[g].push(t[b]());
                    else
                      void 0 == s.basic[b]
                        ? v.resolvedType.group
                          ? c[g].push(n[y].decode(t))
                          : c[g].push(n[y].decode(t, t.uint32()))
                        : c[g].push(t[b]());
                  else
                    void 0 == s.basic[b]
                      ? v.resolvedType.group
                        ? (c[g] = n[y].decode(t))
                        : (c[g] = n[y].decode(t, t.uint32()))
                      : (c[g] = t[b]());
                  break;
                }
              }
              m || (console.log("t", d), t.skipType(7 & d));
            }
            for (y = 0; y < e._fieldsArray.length; ++y) {
              var _ = e._fieldsArray[y];
              if (_.required && !c.hasOwnProperty(_.name))
                throw a.ProtocolError(r(_), { instance: c });
            }
            return c;
          };
        };
        ...
        if (e.resolvedType)
          if (e.resolvedType instanceof o) {
            for (
              ...
              if (
                !(
                  (e.repeated && c[d[p]] === e.typeDefault) ||
                  (d[p] != l && c[d[p]] != l)
                )
              ) {
                f ? (n[i][h] = c[d[p]]) : (n[i] = c[d[p]]);
                break;
              }
          } else {
            if ("object" != typeof (f ? a[i][h] : a[i]))
              throw TypeError(e.fullName + ": object expected");
            f
              ? (n[i][h] = u[t].fromObject(a[i][h]))
              : (n[i] = u[t].fromObject(a[i]));
          }
        else {
          var y = !1;
          switch (e.type) {
            case "double":
            case "float":
              f ? (n[i][h] = Number(a[i][h])) : (n[i] = Number(a[i]));
              break;
            case "uint32":
            case "fixed32":
              f ? (n[i][h] = a[i][h] >>> 0) : (n[i] = a[i] >>> 0);
              break;
            case "int32":
            case "sint32":
            case "sfixed32":
              f ? (n[i][h] = 0 | a[i][h]) : (n[i] = 0 | a[i]);
              break;
            case "uint64":
              y = !0;
            case "int64":
            ...
            case "sfixed64":
              s.Long
                ? f
                  ? (n[i][h] = s.Long.fromValue(a[i][h]).unsigned = y)
                  : (n[i] = s.Long.fromValue(a[i]).unsigned = y)
                : "string" == typeof (f ? a[i][h] : a[i])
                ? f
                  ? (n[i][h] = parseInt(a[i][h], 10))
                  : (n[i] = parseInt(a[i], 10))
                : "number" == typeof (f ? a[i][h] : a[i])
                ? f
                  ? (n[i][h] = a[i][h])
                  : (n[i] = a[i])
                : "object" == typeof (f ? a[i][h] : a[i]) &&
                  (f
                    ? (n[i][h] = new s.LongBits(
                        a[i][h].low >>> 0,
                        a[i][h].high >>> 0
                      ).toNumber(y))
                    : (n[i] = new s.LongBits(
            ...
            case "bytes":
              "string" == typeof (f ? a[i][h] : a[i])
                ? f
                  ? s.base64.decode(
                      a[i][h],
                      (n[i][h] = s.newBuffer(s.base64.length(a[i][h]))),
                      0
                    )
                  : s.base64.decode(
                      a[i],
                      (n[i] = s.newBuffer(s.base64.length(a[i]))),
                      0
                    )
                : (f ? a[i][h] : a[i]).length &&
                  (f ? (n[i][h] = a[i][h]) : (n[i] = a[i]));
              break;
            case "string":
              f ? (n[i][h] = String(a[i][h])) : (n[i] = String(a[i]));
              break;
            case "bool":
              f ? (n[i][h] = Boolean(a[i][h])) : (n[i] = Boolean(a[i]));
          }
        }
      }
      function n(e, t, i, r) {
        var n = r.m,
          ...
          l = void 0 !== h;
        if (e.resolvedType)
          e.resolvedType instanceof o
            ? l
              ? (a[i][h] = f.enums === String ? u[t].values[n[i][h]] : n[i][h])
              : (a[i] = f.enums === String ? u[t].values[n[i]] : n[i])
            : l
            ? (a[i][h] = u[t].toObject(n[i][h], f))
            : (a[i] = u[t].toObject(n[i], f));
        else {
          var c = !1;
          switch (e.type) {
            case "double":
            case "float":
              l
                ? (a[i][h] =
                    f.json && !isFinite(n[i][h]) ? String(n[i][h]) : n[i][h])
                : (a[i] = f.json && !isFinite(n[i]) ? String(n[i]) : n[i]);
              break;
            case "uint64":
              c = !0;
            case "int64":
            ...
            case "sfixed64":
              "number" == typeof n[i][h]
                ? l
                  ? (a[i][h] = f.longs === String ? String(n[i][h]) : n[i][h])
                  : (a[i] = f.longs === String ? String(n[i]) : n[i])
                : l
                ? (a[i][h] =
                    f.longs === String
                      ? s.Long.prototype.toString.call(n[i][h])
                      : f.longs === Number
                      ? new s.LongBits(
                          n[i][h].low >>> 0,
                          n[i][h].high >>> 0
                ...
                : (a[i] =
                    f.longs === String
                      ? s.Long.prototype.toString.call(n[i])
                      : f.longs === Number
                      ? new s.LongBits(
                          n[i].low >>> 0,
                          n[i].high >>> 0
            ...
            case "bytes":
              l
                ? (a[i][h] =
                    f.bytes === String
                      ? s.base64.encode(n[i][h], 0, n[i][h].length)
                      : f.bytes === Array
                      ? Array.prototype.slice.call(n[i][h])
                      : n[i][h])
                : (a[i] =
                    f.bytes === String
                      ? s.base64.encode(n[i], 0, n[i].length)
                      : f.bytes === Array
                      ? Array.prototype.slice.call(n[i])
                      : n[i]);
              break;
            default:
              l ? (a[i][h] = n[i][h]) : (a[i] = n[i]);
          }
        }
      }
      var o,
        ...
        (a.fromObject = function (e) {
          ...
          return function (e) {
            return function (i) {
              ...
              for (var n = new this.ctor(), a = 0; a < t.length; ++a) {
                var u,
                  h = t[a].resolve(),
                  f = h.name;
                if (h.map) {
                  if (i[f]) {
                    if ("object" != typeof i[f])
                      throw TypeError(h.fullName + ": object expected");
                    n[f] = {};
                  }
                  var l = Object.keys(i[f]);
                  for (u = 0; u < l.length; ++u)
                    r(h, a, f, s.merge(s.copy(e), { m: n, d: i, ksi: l[u] }));
                } else if (h.repeated) {
                  if (i[f]) {
                    if (!Array.isArray(i[f]))
                      throw TypeError(h.fullName + ": array expected");
                    for (n[f] = [], u = 0; u < i[f].length; ++u)
                      r(h, a, f, s.merge(s.copy(e), { m: n, d: i, ksi: u }));
                  }
                } else
                  (h.resolvedType instanceof o || null != i[f]) &&
                    r(h, a, f, s.merge(s.copy(e), { m: n, d: i }));
              }
              return n;
            };
          };
            ...
            return t.length
              ? function (r, a) {
                  ...
                  for (
                    ...
                    t[p].partOf ||
                      (t[p].resolve().repeated ? l : t[p].map ? c : d).push(
                        t[p]
                      );
                  if (l.length && (a.arrays || a.defaults))
                    for (p = 0; p < l.length; ++p) f[l[p].name] = [];
                  if (c.length && (a.objects || a.defaults))
                    for (p = 0; p < c.length; ++p) f[c[p].name] = {};
                  if (d.length && a.defaults)
                    for (p = 0; p < d.length; ++p)
                      if (
                        ((u = d[p]), (h = u.name), u.resolvedType instanceof o)
                      )
                        f[h] = a.enums = String
                  ...
                  for (p = 0; p < t.length; ++p) {
                    ...
                    var v,
                      g,
                      b = e._fieldsArray.indexOf(u);
                    if (u.map) {
                      if (
                        (m || (m = !0), r[h] && (v = Object.keys(r[h]).length))
                      )
                        for (f[h] = {}, g = 0; g < v.length; ++g)
                          n(
                            u,
                            b,
                            h,
                            s.merge(s.copy(i), { m: r, d: f, ksi: v[g], o: a })
                          );
                    } else if (u.repeated) {
                      if (r[h] && r[h].length)
                        for (f[h] = [], g = 0; g < r[h].length; ++g)
                          n(
                            u,
                            b,
                            h,
                            s.merge(s.copy(i), { m: r, d: f, ksi: g, o: a })
                          );
                    } else
                      null != r[h] &&
                        r.hasOwnProperty(h) &&
                        n(u, b, h, s.merge(s.copy(i), { m: r, d: f, o: a })),
                        u.partOf && a.oneofs && (f[u.partOf.name] = h);
                  }
                  return f;
                }
              : function () {
      ...
      t.FrameEntity = function e(t) {
        ...
        var i =
          ...
          l =
            ...
            this.transform.d * (this.layout.y + this.layout.height) +
            this.transform.ty;
        (this.nx = Math.min(Math.min(s, a), Math.min(i, o))),
          (this.ny = Math.min(Math.min(f, l), Math.min(u, h)));
      };
    },
    function (e, t, i) {
      !(function (t) {
          ...
          function r(e, t, i) {
            return (
              "function" == typeof t
                ? ((i = t), (t = new o.Root()))
                : t || (t = new o.Root()),
              t.parseFromPbString(e, i)
            );
          }
          function n() {
            o.converter._configure(),
              o.decoder._configure(),
              o.encoder._configure(),
              o.Field._configure(),
              o.MapField._configure(),
              o.Message._configure(),
              o.Namespace._configure(),
              o.Method._configure(),
              o.ReflectionObject._configure(),
              o.OneOf._configure(),
              o.parse._configure(),
              o.Reader._configure(),
              o.Root._configure(),
              o.Service._configure(),
              o.verifier._configure(),
              o.Type._configure(),
              o.types._configure(),
              o.wrappers._configure(),
              o.Writer._configure();
          }
          var o = {};
          if (
            ...
            (o.load = e),
            (o.loadSync = t),
            (o.parseFromPbString = r),
            n(),
            arguments && arguments.length)
          )
            for (var s = 0; s < arguments.length; s++) {
              var a = arguments[s];
              if (a.hasOwnProperty("exports")) return void (a.exports = o);
            }
          return o;
        })();
      })();
    ...
    function (e, t) {
      ...
      function n(e, t) {
        ...
        return t
          ? ((e >>>= 0),
            (n = 0 <= e && e < 256) && (r = l[e])
              ? r
              : ((i = s(e, (0 | e) < 0 ? -1 : 0, !0)), n && (l[e] = i), i))
          : ((e |= 0),
            (n = -128 <= e && e < 128) && (r = f[e])
              ? r
              : ((i = s(e, e < 0 ? -1 : 0, !1)), n && (f[e] = i), i));
      }
      function o(e, t) {
        if (isNaN(e)) return t ? g : v;
        if (t) {
          if (e < 0) return g;
          if (e >= p) return x;
        } else {
      ...
      function a(e, t, i) {
        ...
        if (0 === r) return a(e.substring(1), t, i).neg();
        for (var n = o(c(i, 8)), s = v, u = 0; u < e.length; u += 8) {
          var h = Math.min(8, e.length - u),
            f = parseInt(e.substring(u, u + h), i);
          if (h < 8) {
            var l = o(c(i, h));
            s = s.mul(l).add(o(f));
          } else (s = s.mul(n)), (s = s.add(o(f)));
        }
      ...
      var f = {},
        l = {};
      (i.fromInt = n), (i.fromNumber = o), (i.fromBits = s);
      var c = Math.pow;
      (i.fromString = a), (i.fromValue = u);
      var d = 4294967296,
        p = d * d,
        y = p / 2,
        m = n(1 << 24),
      ...
      i.MAX_VALUE = k;
      var x = s(-1, -1, !0);
      i.MAX_UNSIGNED_VALUE = x;
      var A = s(0, -2147483648, !1);
      i.MIN_VALUE = A;
      var O = i.prototype;
      (O.toInt = function () {
        ...
        (O.toString = function (e) {
          ...
          for (var n = o(c(e, 6), this.unsigned), s = this, a = ""; ; ) {
            var u = s.div(n),
        ...
        (O.compare = function (e) {
          if ((r(e) || (e = u(e)), this.eq(e))) return 0;
        ...
        (O.multiply = function (e) {
          ...
          if ((r(e) || (e = u(e)), h)) {
            return s(
              h.mul(this.low, this.high, e.low, e.high),
              h.get_high(),
              this.unsigned
            );
          }
          if (e.isZero()) return v;
          if (this.eq(A)) return e.isOdd() ? A : v;
          if (e.eq(A)) return this.isOdd() ? A : v;
          if (this.isNegative())
            return e.isNegative()
              ? this.neg().mul(e.neg())
              : this.neg().mul(e).neg();
          ...
          return (
            ...
            (p += t * d + i * c + n * l + a * f),
            (p &= 65535),
            s((g << 16) | b, (p << 16) | y, this.unsigned)
          );
        }),
        (O.mul = O.multiply),
        (O.divide = function (e) {
          if ((r(e) || (e = u(e)), e.isZero())) throw Error("division by zero");
          if (h) {
            if (
              !this.unsigned &&
          ...
          if (this.unsigned) {
            ...
            if (this.eq(A)) {
              if (e.eq(b) || e.eq(_)) return A;
              if (e.eq(A)) return b;
              return (
                (t = this.shr(1).div(e).shl(1)),
                t.eq(v)
                  ? e.isNegative()
                    ? b
                    : _
                  : ((i = this.sub(e.mul(t))), (n = t.add(i.div(e))))
              );
            }
            if (e.eq(A)) return this.unsigned ? g : v;
            if (this.isNegative())
              return e.isNegative()
                ? this.neg().div(e.neg())
                : this.neg().div(e).neg();
          ...
          for (i = this; i.gte(e); ) {
            ...
            for (
              ...
              (t -= f), (l = o(t, this.unsigned)), (d = l.mul(e));
            l.isZero() && (l = b), (n = n.add(l)), (i = i.sub(d));
          }
          return n;
        }),
        (O.div = O.divide),
          ...
          "undefined" != typeof Float32Array
            ? (function () {
                ...
                var o = new Float32Array([-0]),
                  ...
                  a = 128 === s[3];
                (e.writeFloatLE = a ? t : i),
                  (e.writeFloatBE = a ? i : t),
                  (e.readFloatLE = a ? r : n),
                  (e.readFloatBE = a ? n : r);
              })()
            : (function () {
          ...
          "undefined" != typeof Float64Array
            ? (function () {
                ...
                var o = new Float64Array([-0]),
                  s = new Uint8Array(o.buffer),
                  a = 128 === s[7];
                (e.writeDoubleLE = a ? t : i),
                  (e.writeDoubleBE = a ? i : t),
                  (e.readDoubleLE = a ? r : n),
                  (e.readDoubleBE = a ? n : r);
              })()
            : (function () {
                function t(e, t, i, r, n, o) {
                  var s = r < 0 ? 1 : 0;
                  if ((s && (r = -r), 0 === r))
                    e(0, n, o + t), e(1 / r > 0 ? 0 : 2147483648, n, o + i);
                  else if (isNaN(r)) e(0, n, o + t), e(2146959360, n, o + i);
                  else if (r > 1.7976931348623157e308)
                    e(0, n, o + t), e(((s << 31) | 2146435072) >>> 0, n, o + i);
                  else {
                    var a;
                    if (r < 2.2250738585072014e-308)
                      (a = r / 5e-324),
                        e(a >>> 0, n, o + t),
                        e(((s << 31) | (a / 4294967296)) >>> 0, n, o + i);
                    else {
                ...
                function i(e, t, i, r, n) {
                  ...
                  return 2047 === u
                    ...
                    : 0 === u
                    ? 5e-324 * a * h
                    : a * Math.pow(2, u - 1075) * (h + 4503599627370496);
                }
    ...
    function (e, t, i) {
      ...
      function r(e, t) {
        for (
          var i = new Array(arguments.length - 1), r = 0, n = 2, o = !0;
          n < arguments.length;
    ...
    function (e, t) {
      ...
      i.resolve = function (e, t, i) {
        return (
          i || (t = n(t)),
          r(t)
            ? t
            : (i || (e = n(e)),
              (e = e.replace(/(?:\/|^)[^/]+$/, "")).length ? n(e + "/" + t) : t)
        );
      };
    },
    function (e, t, i) {
      "use strict";
      var r = i(19),
        n = r.ProtoMovieEntity,
        o = i(9).assign,
        s = i(45),
        a = {};
      o(a, s);
      var u = function (e) {
          for (var t = [], i = 0; i < e.length; i += 32768)
            t.push(String.fromCharCode.apply(null, e.subarray(i, i + 32768)));
          return t.join("");
        },
        h = {
          loadAssets: function (e, t, i) {
            if ("undefined" != typeof wx)
              ...
              r.open("GET", e, !0),
                ...
                (r.onloadend = function () {
                  h.load_viaProto(r.response, t, i);
                }),
                r.send();
            }
          },
          load_viaProto: function (e, t, i) {
            try {
              var r = a.inflate(e),
                o = n.decode(r),
                s = {};
              h._loadImages(s, o, function () {
                (o.ver = "2.0"), t({ movie: o, images: s });
              });
            } catch (e) {
              throw (i && i(e), console.error(e), e);
            }
          },
          _loadImages: function (e, t, i) {
            for (var r in t.images)
              if (t.images.hasOwnProperty(r)) {
                var n = t.images[r];
                if (
                  "undefined" != typeof wx &&
                  void 0 !== wx.arrayBufferToBase64
                )
                  e[r] = wx.arrayBufferToBase64(n);
                else {
                  var o = u(n);
                  e[r] = btoa(o);
                }
    ...
    function (e, t, i) {
      ...
      function r(e) {
        ...
        if (i !== h.Z_OK) throw new Error(f[i]);
        if (
          ((this.header = new c()),
          s.inflateGetHeader(this.strm, this.header),
          t.dictionary &&
            ("string" == typeof t.dictionary
              ? (t.dictionary = u.string2buf(t.dictionary))
              : "[object ArrayBuffer]" === d.call(t.dictionary) &&
                (t.dictionary = new Uint8Array(t.dictionary)),
            t.raw &&
              (i = s.inflateSetDictionary(this.strm, t.dictionary)) !== h.Z_OK))
        )
          throw new Error(f[i]);
      }
      function n(e, t) {
        var i = new r(t);
        if ((i.push(e, !0), i.err)) throw i.msg || f[i.err];
        return i.result;
      }
      function o(e, t) {
      ...
      (r.prototype.push = function (e, t) {
        ...
        (r = t === ~~t ? t : !0 === t ? h.Z_FINISH : h.Z_NO_FLUSH),
          "string" == typeof e
            ? (l.input = u.binstring2buf(e))
        ...
        do {
          if (
            (0 === l.avail_out &&
              ((l.output = new a.Buf8(c)), (l.next_out = 0), (l.avail_out = c)),
            (i = s.inflate(l, h.Z_NO_FLUSH)),
            i === h.Z_NEED_DICT &&
              p &&
              (i = s.inflateSetDictionary(this.strm, p)),
            i === h.Z_BUF_ERROR && !0 === y && ((i = h.Z_OK), (y = !1)),
          ...
          l.next_out &&
            ((0 !== l.avail_out &&
              i !== h.Z_STREAM_END &&
              (0 !== l.avail_in ||
                (r !== h.Z_FINISH && r !== h.Z_SYNC_FLUSH))) ||
              ("string" === this.options.to
                ? ((n = u.utf8border(l.output, l.next_out)),
                  (o = l.next_out - n),
                  (f = u.buf2string(l.output, n)),
                  (l.next_out = o),
                  (l.avail_out = c - o),
                  o && a.arraySet(l.output, l.output, n, o, 0),
                  this.onData(f))
                : this.onData(a.shrinkBuf(l.output, l.next_out)))),
            0 === l.avail_in && 0 === l.avail_out && (y = !0);
        } while ((l.avail_in > 0 || 0 === l.avail_out) && i !== h.Z_STREAM_END);
        return (
          i === h.Z_STREAM_END && (r = h.Z_FINISH),
          r === h.Z_FINISH
            ? ((i = s.inflateEnd(this.strm)),
              ...
              i === h.Z_OK)
            : r !== h.Z_SYNC_FLUSH ||
              (this.onEnd(h.Z_OK), (l.avail_out = 0), !0)
        );
      }),
    ...
    function (e, t, i) {
      ...
      function f(e) {
        if (ge) {
          ...
          for (k(A, e.lens, 0, 288, m, 0, e.work, { bits: 9 }), t = 0; t < 32; )
            e.lens[t++] = 5;
          k(O, e.lens, 0, 32, v, 0, e.work, { bits: 5 }), (ge = !1);
        }
      ...
      function l(e, t, i, r) {
        ...
        return (
          ...
          r >= o.wsize
            ? (g.arraySet(o.window, t, i - o.wsize, o.wsize, 0),
              (o.wnext = 0),
              (o.whave = o.wsize))
            : ((n = o.wsize - o.wnext),
              n > r && (n = r),
              g.arraySet(o.window, t, i - r, n, o.wnext),
              (r -= n),
              r
                ? (g.arraySet(o.window, t, i - r, r, 0),
                  (o.wnext = r),
                  (o.whave = o.wsize))
                : ((o.wnext += n),
      ...
      function c(e, t) {
        ...
        e: for (;;)
          switch (i.mode) {
            case M:
              ...
              if (((c >>>= 4), (d -= 4), (ke = 8 + (15 & c)), 0 === i.wbits))
                i.wbits = ke;
              else if (ke > i.wbits) {
            ...
            case Z:
              if (
                ...
                m &&
                  (i.head &&
                    ((ke = i.head.extra_len - i.length),
                    i.head.extra ||
                      (i.head.extra = new Array(i.head.extra_len)),
                    g.arraySet(i.head.extra, n, s, m, ke)),
                  512 & i.flags && (i.check = w(i.check, n, m, s)),
                  (u -= m),
                  (s += m),
                  (i.length -= m)),
                i.length)
                ...
                do {
                  (ke = n[s + m++]),
                    i.head &&
                      ke &&
                      i.length < 65536 &&
                      (i.head.name += String.fromCharCode(ke));
                } while (ke && m < u);
                if (
                  (512 & i.flags && (i.check = w(i.check, n, m, s)),
                  (u -= m),
                ...
                do {
                  (ke = n[s + m++]),
                    i.head &&
                      ke &&
                      i.length < 65536 &&
                      (i.head.comment += String.fromCharCode(ke));
                } while (ke && m < u);
                if (
                  (512 & i.flags && (i.check = w(i.check, n, m, s)),
                  (u -= m),
            ...
            case K:
              ...
              (e.adler = i.check = r(c)), (c = 0), (d = 0), (i.mode = $);
            case $:
              if (0 === i.havedict)
                return (
                  (e.next_out = a),
            ...
            case W:
              ...
              switch (((i.last = 1 & c), (c >>>= 1), (d -= 1), 3 & c)) {
                case 0:
                  i.mode = G;
                  break;
                case 1:
                  if ((f(i), (i.mode = ie), t === T)) {
                    (c >>>= 2), (d -= 2);
                    break e;
                  }
                  break;
            ...
            case ee:
              for (; i.have < i.ncode; ) {
                ...
                (i.lens[Te[i.have++]] = 7 & c), (c >>>= 3), (d -= 3);
              }
              for (; i.have < 19; ) i.lens[Te[i.have++]] = 0;
              if (
                ((i.lencode = i.lendyn),
                (i.lenbits = 7),
                (Ae = { bits: i.lenbits }),
                (xe = k(x, i.lens, 0, 19, i.lencode, 0, i.work, Ae)),
                (i.lenbits = Ae.bits),
                xe)
              ) {
            ...
            case te:
              for (; i.have < i.nlen + i.ndist; ) {
                ...
                if (ge < 16) (c >>>= me), (d -= me), (i.lens[i.have++] = ge);
                else {
                  if (16 === ge) {
                    for (Oe = me + 2; d < Oe; ) {
                      if (0 === u) break e;
              ...
              if (
                ((i.lenbits = 9),
                (Ae = { bits: i.lenbits }),
                (xe = k(A, i.lens, 0, i.nlen, i.lencode, 0, i.work, Ae)),
                (i.lenbits = Ae.bits),
                xe)
              ) {
              ...
              if (
                ...
                (Ae = { bits: i.distbits }),
                (xe = k(O, i.lens, i.nlen, i.ndist, i.distcode, 0, i.work, Ae)),
                (i.distbits = Ae.bits),
                xe)
              ) {
            ...
            case re:
              ...
              if (ve && 0 == (240 & ve)) {
                for (
                  be = me, we = ve, _e = ge;
                  (Se = i.lencode[_e + ((c & ((1 << (be + we)) - 1)) >> be)]),
                    (me = Se >>> 24),
                    (ve = (Se >>> 16) & 255),
                    (ge = 65535 & Se),
                    !(be + me <= d);
            ...
            case oe:
              for (
                ;
                (Se = i.distcode[c & ((1 << i.distbits) - 1)]),
                  (me = Se >>> 24),
                  (ve = (Se >>> 16) & 255),
                  (ge = 65535 & Se),
                  !(me <= d);
              ...
              if (0 == (240 & ve)) {
                for (
                  be = me, we = ve, _e = ge;
                  (Se = i.distcode[_e + ((c & ((1 << (be + we)) - 1)) >> be)]),
                    (me = Se >>> 24),
                    (ve = (Se >>> 16) & 255),
                    (ge = 65535 & Se),
                    !(be + me <= d);
              ...
              if (((c >>>= me), (d -= me), (i.back += me), 64 & ve)) {
                (e.msg = "invalid distance code"), (i.mode = ce);
                break;
              }
              (i.offset = ge), (i.extra = 15 & ve), (i.mode = se);
            case se:
              if (i.extra) {
                for (Oe = i.extra; d < Oe; ) {
                  if (0 === u) break e;
            ...
            case ae:
              ...
              if (((m = y - h), i.offset > m)) {
                ...
                m > i.wnext
                  ? ((m -= i.wnext), (v = i.wsize - m))
                  : (v = i.wnext - m),
                  m > i.length && (m = i.length),
                  (ye = i.window);
              } else (ye = o), (v = a - i.offset), (m = i.length);
        ...
        return (
          ...
          (i.bits = d),
          (i.wsize ||
            (y !== e.avail_out && i.mode < ce && (i.mode < he || t !== S))) &&
          l(e, e.output, e.next_out, y - e.avail_out)
            ? ((i.mode = de), B)
            : ((p -= e.avail_in),
              (y -= e.avail_out),
              (e.total_in += p),
              ...
              i.wrap &&
                y &&
                (e.adler = i.check = i.flags
                  ? w(i.check, o, y, e.next_out - y)
                  : b(i.check, o, y, e.next_out - y)),
              (e.data_type =
                i.bits +
                (i.last ? 64 : 0) +
                (i.mode === H ? 128 : 0) +
                (i.mode === ie || i.mode === X ? 256 : 0)),
              ((0 === p && 0 === y) || t === S) && xe === N && (xe = R),
              xe)
        );
      }
      function d(e) {
      ...
      function p(e, t) {
        ...
        return e && e.state
          ? ((i = e.state),
            0 == (2 & i.wrap) ? I : ((i.head = t), (t.done = !1), N))
          : I;
      }
      function y(e, t) {
        var i,
        ...
        return e && e.state
          ? ((i = e.state),
            0 !== i.wrap && i.mode !== $
              ? I
              : i.mode === $ && ((r = 1), (r = b(r, t, n, 0)) !== i.check)
              ? C
              : l(e, t, n, n)
              ? ((i.mode = de), B)
              : ((i.havedict = 1), N))
    ...
    function (e, t, i) {
      ...
      e.exports = function (e, t, i, u, h, f, l, c) {
        var d,
          p,
          y,
          m,
        ...
        for (A = 0; A < u; A++) R[t[i + A]]++;
        for (E = k, S = 15; S >= 1 && 0 === R[S]; S--);
        if ((E > S && (E = S), 0 === S))
          return (h[f++] = 20971520), (h[f++] = 20971520), (c.bits = 1), 0;
        for (O = 1; O < S && 0 === R[O]; O++);
        for (E < O && (E = O), j = 1, x = 1; x <= 15; x++)
          if (((j <<= 1), (j -= R[x]) < 0)) return -1;
        if (j > 0 && (0 === e || 1 !== S)) return -1;
        for (P[1] = 0, x = 1; x < 15; x++) P[x + 1] = P[x] + R[x];
        for (A = 0; A < u; A++) 0 !== t[i + A] && (l[P[t[i + A]]++] = A);
        if (
          (0 === e
            ? ((C = M = l), (g = 19))
            : 1 === e
            ? ((C = n), (B -= 257), (M = o), (D -= 257), (g = 256))
            : ((C = s), (M = a), (g = -1)),
          (I = 0),
          (A = 0),
          (x = O),
        ...
        for (;;) {
          (b = x - N),
            ...
            (O = p);
          do {
            (p -= d), (h[v + (I >> N) + p] = (b << 24) | (w << 16) | _ | 0);
          } while (0 !== p);
          for (d = 1 << (x - 1); I & d; ) d >>= 1;
          if (
            (0 !== d ? ((I &= d - 1), (I += d)) : (I = 0), A++, 0 == --R[x])
          ) {
            if (x === S) break;
            x = t[i + l[A]];
          }
          if (x > E && (I & m) !== y) {
            ...
            if (((F += 1 << T), (1 === e && F > 852) || (2 === e && F > 592)))
              return 1;
            (y = I & m), (h[y] = (E << 24) | (T << 16) | (v - f) | 0);
          }
        }
        return (
          0 !== I && (h[v + I] = ((x - N) << 24) | (64 << 16) | 0),
          (c.bits = E),
          0
        );
      };
    ...
    function (e, t, i) {
      ...
      (a[254] = a[254] = 1),
        (t.string2buf = function (e) {
          ...
          for (o = 0; o < a; o++)
            (i = e.charCodeAt(o)),
              ...
              (u += i < 128 ? 1 : i < 2048 ? 2 : i < 65536 ? 3 : 4);
        ...
        (t.buf2string = function (e, t) {
          ...
          for (n = 0, i = 0; i < u; )
            if ((o = e[i++]) < 128) h[n++] = o;
            else if ((s = a[o]) > 4) (h[n++] = 65533), (i += s - 1);
            else {
              for (o &= 2 === s ? 31 : 3 === s ? 15 : 7; s > 1 && i < u; )
                (o = (o << 6) | (63 & e[i++])), s--;
              s > 1
                ? (h[n++] = 65533)
                : o < 65536
    ...
    function (e, t, i) {
      ...
      var r = i(33),
        n = i(58);
      e.exports = { Parser: r.Parser, Player: n.Player };
    },
    function (e, t, i) {
      "use strict";
      function r(e, t) {
      ...
      t.Player = (function () {
        function e(t) {
          r(this, e),
            ...
            "undefined" != typeof wx
              ? ((this._container =
                  "string" == typeof t
                    ? wx.createSelectorQuery().select(t)
                    : t),
                this._init())
              : ((this._container =
        ...
        return (
          o(e, [
            ...
            { key: "setClipsToBounds", value: function (e) {} },
            {
              key: "startAnimation",
              value: function (e) {
            ...
            },
            {
              ...
              value: function (e, t) {
                ...
                i >= this._videoItem.frames &&
                  i > 0 &&
                  (i = this._videoItem.frames - 1),
                  this.stepToFrame(i, t);
              },
            },
            {
              key: "setImage",
              value: function (e, t, i) {
                (this._dynamicImage[t] = e),
                  void 0 !== i &&
                    i instanceof Array &&
                    6 == i.length &&
                    (this._dynamicImageTransform[t] = i);
              },
            },
            {
              key: "setText",
              ...
              value: function () {
                ...
                if ("undefined" != typeof wx)
                  this._container
                    ...
                    .exec(function (t) {
                      e._drawingCanvas = t[0].node;
                      var i = wx.getSystemInfoSync().pixelRatio;
                      (e._drawingCanvas.width = t[0].width * i),
                        (e._drawingCanvas.height = t[0].height * i),
                        void 0 !== e._animator &&
                          (e._animator.canvas = e._drawingCanvas);
                    });
                else if (
                  ...
                  if (this._container)
                    for (
                      var t = this._container.querySelectorAll("canvas"), i = 0;
                      i < t.length;
                      i++
                    ) {
                      var r = t[i];
            ...
            },
            {
              ...
              value: function (e, t, i) {
                var r = this;
                (this._animator = new u()),
                  void 0 !== this._drawingCanvas &&
                    null !== this._drawingCanvas &&
                  ...
                  (this._animator.onUpdate = function (e) {
                    r._currentFrame !== Math.floor(e) &&
                      (r._forwardAnimating &&
                        r._currentFrame > Math.floor(e) &&
                        r._renderer.clearAudios(),
                      (r._currentFrame = Math.floor(e)),
                      r._update(),
                      "function" == typeof r._onFrame &&
                        r._onFrame(r._currentFrame),
                      "function" == typeof r._onPercentage &&
                        r._onPercentage(
                          parseFloat(r._currentFrame + 1) /
                            parseFloat(r._videoItem.frames)
                        ));
                  }),
                  ...
                  !0 === t
                    ? (this._animator.reverse(i), (this._forwardAnimating = !1))
                    : (this._animator.start(i), (this._forwardAnimating = !0)),
            ...
            },
            {
              ...
              value: function () {
                var e = !1,
                  t = this.ctx || this._drawingCanvas.getContext("2d");
                if (
                  (void 0 === this.ctx && (this.ctx = t), this._drawingCanvas)
                ) {
                  var i = void 0;
                  i = this._drawingCanvas.parentNode
                    ? {
                  ...
                  if (i.width >= r.width && i.height >= r.height)
                    (this._drawingCanvas.width = i.width),
                    ...
                    if (
                      ...
                      var n = i.width / r.width,
                        o = i.height / r.height,
                        s = (r.width * n - r.width) / 2,
                        a = (r.height * o - r.height) / 2;
                      t.setTransform(n, 0, 0, o, s, a);
                    } else if (
                      ...
                      var u = r.width / r.height,
                        h = i.width / i.height;
                      if (
                        (u >= h && "AspectFit" === this._contentMode) ||
                        (u <= h && "AspectFill" === this._contentMode)
                      ) {
                        var f = i.width / r.width,
                          l = (r.width * f - r.width) / 2,
                          c =
                            (r.height * f - r.height) / 2 +
                            (i.height - r.height * f) / 2;
                        t.setTransform(1, 0, 0, 1, l, c);
                      } else if (
                        (u < h && "AspectFit" === this._contentMode) ||
                        (u > h && "AspectFill" === this._contentMode)
                      ) {
                        var d = i.height / r.height,
                          p =
                            (r.width * d - r.width) / 2 +
                            (i.width - r.width * d) / 2,
                          y = (r.height * d - r.height) / 2;
                        t.setTransform(1, 0, 0, 1, p, y);
                      }
                    }
                ...
                if (void 0 === this._drawingCanvas || !0 === e) {
                  ...
                  if ("Fill" === this._contentMode)
                    (m = w.width / _.width), (v = w.height / _.height);
                  else if (
                    "AspectFit" === this._contentMode ||
                    "AspectFill" === this._contentMode
                  ) {
                    var k = _.width / _.height,
                      x = w.width / w.height;
                    (k >= x && "AspectFit" === this._contentMode) ||
                    (k <= x && "AspectFill" === this._contentMode)
                      ? ((m = v = w.width / _.width),
                        (b = (w.height - _.height * v) / 2))
                      : ((k < x && "AspectFit" === this._contentMode) ||
                          (k > x && "AspectFill" === this._contentMode)) &&
                        ((m = v = w.height / _.height),
                        (g = (w.width - _.width * m) / 2));
                  }
    ...
    function (e, t, i) {
      ...
      function n(e, t, i) {
        var r = Math.random().toString() + ".png";
        wx.getFileSystemManager().writeFile({
          filePath: wx.env.USER_DATA_PATH + "/" + r,
          data: t,
          encoding: "string" == typeof t ? "base64" : "binary",
          success: function () {
            var t = e.createImage();
            (t.onload = function () {
              i(t),
                wx
                  ...
                  .unlink({ filePath: wx.env.USER_DATA_PATH + "/" + r });
            }),
              (t.src = wx.env.USER_DATA_PATH + "/" + r);
          },
          fail: function (e) {
            console.error(e);
          },
          ...
          s(e, [
            {
              ...
              value: function () {
                ...
                void 0 === this._bitmapCache &&
                  (function () {
                    e._bitmapCache = {};
                    var t = 0,
                      i = 0;
                    for (var r in e._owner._videoItem.images)
                      !(function (r) {
                        var o = e._owner._videoItem.images[r];
                        if (
                          0 === o.indexOf("iVBO") ||
                          0 === o.indexOf("/9j/2w")
                        )
                          if (
                            (t++,
                            e._owner._drawingCanvas &&
                              e._owner._drawingCanvas.createImage)
                          )
                            n(e._owner._drawingCanvas, o, function (n) {
                              var o = r.replace(".matte", "");
                              (e._bitmapCache[o] = n),
                                ++i == t &&
                                  ((e._prepared = !0),
                                  "number" == typeof e._undrawFrame &&
                                    (e.drawFrame(e._undrawFrame),
                                    (e._undrawFrame = void 0)));
                            });
                          else
                            try {
            ...
            },
            {
              ...
              value: function () {
                ...
                void 0 === this.ctx && (this.ctx = e);
                var t = {
                  x: 0,
                  y: 0,
                  width: (this._owner._drawingCanvas || this._owner._container)
                    .width,
                  height: (this._owner._drawingCanvas || this._owner._container)
                    .height,
                };
                ...
                if (this._prepared) {
                  ...
                  s.forEach(function (r, a) {
                    if (-1 == s[0].imageKey.indexOf(".matte"))
                      return void t.drawSprite(r, i, e);
                    if (-1 != r.imageKey.indexOf(".matte"))
                      return void n.set(r.imageKey, r);
                    var u = s[a - 1];
                    if (
                      o &&
                      (null == r.matteKey ||
                        0 == r.matteKey.length ||
                        r.matteKey != u.matteKey)
                    ) {
                      o = !1;
                      var h = n.get(r.matteKey);
            ...
            },
            {
              ...
              value: function (e, t, i) {
                var r = this,
                  n = e.frames[this._owner._currentFrame];
                if (!(n.alpha < 0.05)) {
                  t.save(),
                  ...
                  var s = e.imageKey.replace(".matte", ""),
                    f =
                      this._owner._dynamicImage[s] ||
                      this._bitmapCache[s] ||
                      this._owner._videoItem.images[s];
                  if (
                    "string" != typeof f ||
                    (0 !== f.indexOf("http://") && 0 !== f.indexOf("https://"))
                  ) {
                    if ("object" === (void 0 === f ? "undefined" : o(f))) {
                      if (
                        (void 0 !== n.maskPath &&
                          null !== n.maskPath &&
                          ((n.maskPath._styles = void 0),
                          this.drawBezier(t, n.maskPath),
                          t.clip()),
                        void 0 !==
                          this._owner._dynamicImageTransform[e.imageKey])
                      ) {
                        t.save();
                        var l = this._owner._dynamicImageTransform[e.imageKey];
                        t.transform(l[0], l[1], l[2], l[3], l[4], l[5]);
                      }
                      t.drawImage(f, 0, 0),
                        void 0 !==
                          this._owner._dynamicImageTransform[e.imageKey] &&
                    ...
                    var c = this._owner._drawingCanvas.createImage();
                    (c.src = f), (this._owner._dynamicImage[e.imageKey] = c);
                  }
                  n.shapes &&
                    n.shapes.forEach(function (e) {
                      "shape" === e.type &&
                        e.pathArgs &&
                        e.pathArgs.d &&
                        r.drawBezier(
                          t,
                          new a.BezierPath(e.pathArgs.d, e.transform, e.styles)
                        ),
                        "ellipse" === e.type &&
                          e.pathArgs &&
                          r.drawEllipse(
                  ...
                  var d = this._owner._dynamicText[e.imageKey];
                  if (void 0 !== d) {
                    (t.textBaseline = "middle"), (t.font = d.style);
                    var p = t.measureText(d.text).width;
                    t.fillStyle = d.color;
                    var y =
                        void 0 !== d.offset && void 0 !== d.offset.x
                          ? isNaN(parseFloat(d.offset.x))
                            ? 0
                            : parseFloat(d.offset.x)
                          : 0,
                      m =
                        void 0 !== d.offset && void 0 !== d.offset.y
                          ? isNaN(parseFloat(d.offset.y))
                            ? 0
                            : parseFloat(d.offset.y)
                          : 0;
                    t.fillText(
                      d.text,
                      (n.layout.width - p) / 2 + y,
                      n.layout.height / 2 + m
                    );
                  }
                  t.restore();
              ...
              value: function (e, t) {
                ...
                void 0 !== i &&
                  (i && i.stroke
                    ? (e.strokeStyle =
                        "rgba(" +
                        parseInt(255 * i.stroke[0]) +
                        ", " +
                        parseInt(255 * i.stroke[1]) +
                        ", " +
                        parseInt(255 * i.stroke[2]) +
                        ", " +
                        i.stroke[3] +
                        ")")
                    : (e.strokeStyle = "transparent"),
                  i &&
                    ((e.lineWidth = i.strokeWidth || void 0),
                    (e.lineCap = i.lineCap || void 0),
                    (e.lineJoin = i.lineJoin || void 0),
                    (e.miterLimit = i.miterLimit || void 0)),
                  i && i.fill
                    ? (e.fillStyle =
                        "rgba(" +
                        parseInt(255 * i.fill[0]) +
                        ", " +
                        parseInt(255 * i.fill[1]) +
                        ", " +
                        parseInt(255 * i.fill[2]) +
                        ", " +
                        i.fill[3] +
                        ")")
                    : (e.fillStyle = "transparent"),
                  i && i.lineDash && e.setLineDash(i.lineDash));
              },
            },
            {
              key: "drawBezier",
              value: function (e, t) {
                ...
                var r = { x: 0, y: 0, x1: 0, y1: 0, x2: 0, y2: 0 };
                e.beginPath(),
                  t._d
                    .replace(/([a-zA-Z])/g, "|||$1 ")
                    .replace(/,/g, " ")
            ...
            },
            {
              ...
              value: function (e, t) {
                ...
                e.beginPath(),
                  e.moveTo(i, l),
                  e.bezierCurveTo(i, l - a, f - s, r, f, r),
                  e.bezierCurveTo(f + s, r, u, l - a, u, l),
                  e.bezierCurveTo(u, l + a, f + s, h, f, h),
                  e.bezierCurveTo(f - s, h, i, l + a, i, l),
                  t._styles && t._styles.fill && e.fill(),
                  t._styles && t._styles.stroke && e.stroke(),
                  e.restore();
              },
            },
            {
              ...
              value: function (e, t) {
                ...
                n < 2 * s && (s = n / 2),
                  ...
                  e.beginPath(),
                  e.moveTo(i + s, r),
                  e.arcTo(i + n, r, i + n, r + o, s),
                  e.arcTo(i + n, r + o, i, r + o, s),
                  e.arcTo(i, r + o, i, r, s),
                  e.arcTo(i, r, i + n, r, s),
                  e.closePath(),
                  t._styles && t._styles.fill && e.fill(),
    ...
    function (e, t, i) {
            ...
            },
            {
              ...
              value: function (t) {
                ...
                (this.mReverse = t),
                  ...
                  i &&
                    (this.mStartTime -= t
                      ? (1 - i / (this.endValue - this.startValue)) *
                        this.duration
                      : (i / (this.endValue - this.startValue)) *
                        this.duration),
                  (this.mCurrentFrication = 0),
                  this.onStart(),
                  this.doFrame();
            ...
            },
            {
              ...
              value: function () {
                var t = this,
                  i = function i() {
                    t.mRunning &&
                      (t.doDeltaTime(e.currentTimeMillsecond() - t.mStartTime),
                      t.canvas.requestAnimationFrame(i));
                  };
                this.canvas.requestAnimationFrame(i);
              },
            },
            {
              key: "doDeltaTime",
      ...
      })()).currentTimeMillsecond = function () {
